...
bool robot__msg__motor_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot.msg._motor_cmd.MotorCmd", full_classname_dest, 29) == 0);
  }
  robot__msg__MotorCmd * ros_message = _ros_message;
  {  // q
...
PyObject * robot__msg__motor_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot.msg._motor_cmd");

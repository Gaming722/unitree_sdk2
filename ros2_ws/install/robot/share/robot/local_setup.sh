...
: ${AMENT_CURRENT_PREFIX:="/home/jiaming/Documents/CUHKLRL/unitree_sdk2_dev/ros2_ws/install/robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robot/environment/library_path.sh"
